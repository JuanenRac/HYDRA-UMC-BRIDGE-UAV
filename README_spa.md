...
* ✅ **Enrutado de fase con fallo cerrado y evidencia estática:** una fase futura del SDK desconocida se rechaza. `inspect_request_plan.py` emite el plan de peticiones de vuelo estático del esquema `1.0` sin abrir ningún transporte. *(implementado, probado)*
...
* 🔜 **Adaptador de transporte real MAVLink (Pixhawk/PX4) o DJI OSDK** - se introducirá solo tras seleccionar y probar un controlador de vuelo/SDK real. *(planeado)*
